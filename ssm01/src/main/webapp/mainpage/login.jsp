...
<div class="header">
    ...
    <a href="primary.jsp"><h1>PicShare</h1></a>
        ...
        <div class="container">
            ...
            <div class="col-md-6 col-md-offset-3">
                ...
                <%--Login登陆按钮--%>
             <p>
                    <input type = "button" id="button1" class="btn btn-primary btn-lg btn-block" data-toggle="tab" value = "Login" >
                </p>
                <h3>if you have not account,Please <h5><a href="registe.jsp">click here!</a></h5></h3>
            </div>
        </div>
        <h1> </h1>
</div>
            ...
            $.ajax({//发送ajax请求
                ...
                success : function(data) {//成功返回的数据处理
                    ...
                    if(myJson.name==0) {
                        ...
                        window.location.href="/userpage/picture1.jsp?haha="+username;
                    else
                        $.MsgBox.Alert("提示","用户或密码错误！");
                },
            });
